...
export class AxiosCreateClientMapper {
  static toDomain(data: CreateClientResponse) {
    return {
      id: data.id,
      active: data.ativo,
      cnpj: data.cnpj,
      ...
      subscriptionValue: data.valorAssinatura,
    }
  }

  static toPersistence(data: CreateClientRequest) {
    return {
      cnpj: data.cnpj,
      razaoSocial: data.name,
      nomeFantasia: data.description,
      ...
      telefoneResponsavel: data.phone,
